...
class OrderState(Enum):
    ...
    exploding, reads `LOST` too. A larva's order is `DONE` instead: its egg is reported dead as what it makes
    hatches, and an egg killed first reads the same (in game)."""
    REFUSED = "refused"
